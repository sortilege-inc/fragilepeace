session: 26
epigraph: Setsuna asked to be excused from the séance. Kaage refused her. Then Kitsu Takeko opened the void and two of the dead walked into the arbitration.
---
...
[[Doji Setsuna]] gave the court [[Matsu Morozane]]'s account: poisonings, weather, the unexpected — and the [[Lion Clan|Lion]] winning anyway, against the odds, right up until the Empire stopped the battle. [[Ide Tsubame]] pressed her on whether the Lion advantage was decisive, and she would not overstate it. *The Lion had an edge but not a decisive one.* [[Ide Tsubame]] took that and ran the other way with it: an edge means the Lion could have won without any [[Scorpion Clan|Scorpion]] help at all, so dismiss the claim. [[Shosuro Aishi]] took the same testimony and ran the opposite way — [[Matsu Morozane]]'s own account puts a Scorpion at the first clash and at the treaty signing both, which is presence, and presence is what the claim needs.

[[Kakita Kazumi]] argued that the [[Lion Clan|Lion]] and the [[Unicorn Clan|Unicorn]] were matched in valour, that the Scorpion tried to tilt it and failed, and that what actually ended the battle was Imperial authority. [[Shiba Midori]] told the court about the shugenja general and the infiltrator who tried to kill her — sabotage that hurt the Lion, and pointed at Scorpion collusion with the Unicorn. [[Shosuro Aishi]] answered that the infiltrator wore no clan colours. [[Ide Tsubame]] answered that the Unicorn are entitled to their own counterintelligence.

[[Bayushi Monban]] laid out the irregularities in order. *Point one: the pincer manoeuvre failed, almost as if the Unicorn knew it was happening.* A third of the Lion host poisoned, which bought the [[Imperial Houses]] the time they needed. And the histories erased by [[Ikoma Akuyaku]], a scout bound to the Unicorn.
...
With the floor open, [[Bayushi Monban]] proposed calling the ancestors themselves. [[Doji Setsuna]] asked to be excused from the séance. [[Kitsuki Kaage]] refused her. [[Ide Tsubame]] warned that ghosts can be worked on like anyone else; the Scorpion agreed to it under conditions.
...
- Ide Tsubame: Argued that a Lion edge means the Lion could have won unaided, so the Scorpion claim should be dismissed. Warned that summoned ghosts can be manipulated like any other witness.
...
**She asked to be excused and was refused, and that refusal is the most important thing that happened to her today.** She is about to be in a room where the dead are compelled to speak, carrying [[Matsu Morozane]]'s memories in her own head, with a grandmother — [[Matsu Tomoe]] — who has already told her she is walking with her and watching. Whatever [[Doji Setsuna]] wanted to avoid by leaving, she is now going to be present for.

Her testimony was honest and it cost her the argument. Asked whether the Lion advantage was decisive she said an edge, not a decisive one — which is true, and which [[Ide Tsubame]] immediately used to argue the [[Scorpion Clan|Scorpion]] contributed nothing that mattered. That is the second time this week that telling the truth precisely has strengthened the [[Unicorn Clan|Unicorn]] case. It is not a reason to stop. It is a reason to make the Imperial argument the one she is actually running, since it is the only one where accuracy helps her.
