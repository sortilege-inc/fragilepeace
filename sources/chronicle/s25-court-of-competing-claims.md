session: 25
epigraph: The Shinjukamu letters vanished overnight after Monban's late visit to the library. Setsuna stood up in court and said he had returned them on her behalf.
---
...
[[Shiba Midori]] then produced the rest of the cache — four large scrolls, an unsigned draft, and the lost chronicle of [[Ikoma Hideri]], the account of the Battle of the [[Snow Plain]] that the man was murdered before he could publish. It has been in the ground ever since. [[Ikoma Ichigo]] examined the jar stopper and the pottery with the scrolls and confirmed the seal would have preserved them, and was given leave to fetch comparison samples from the library. [[Bayushi Monban]] spent the recess sitting in the [[Garden Of Virtuous Contemplation]].
...
[[Doji Setsuna]] got to her feet and told the court that [[Bayushi Monban]] had been returning those documents on her behalf, at her request. [[Ide Subane]] did not accept it, and named what the timeline leaves behind: a window, and a man alone in a library with the exemplars.

[[Kitsuki Kaage]] ruled what he could. One of the two secret documents is forged. The chain of proof is not good enough to say which. Testimonial evidence next session; no final ruling until more authentication is in.

## Learned

- Ikoma Ichigo: Authenticated the Imperial-Sealed Official Treaty, which validates the Unicorn claim to the Snow Plain. Found that the signed secret agreement carries no Imperial seal, and that the "least of the Bayushi" clause is too vague to bind. Confirmed the cache scrolls genuine against library samples. Confirmed no secret treaty is on file anywhere — and that the Shinjukamu Letters vanished overnight after Monban's late visit.
- Imperial-Sealed Official Treaty: Genuine, and it puts the Snow Plain in Unicorn hands.
- Ikoma Hideri: His lost chronicle of the Battle of the Snow Plain was in the jar. The account he was murdered before he could finish has been in the ground ever since.
- Ide Subane: Moved to call the librarian to place Monban in the library at unorthodox hours, and refused Setsuna's explanation — the timeline gives a window and a man alone with the exemplars.
- Kitsuki Kaage: Ruled that one of the two competing secret documents is forged, and that the proof is not good enough to say which. Warned Ide Subane what an accusation against an Emerald Magistrate would require. Relieved to have one authentic body of evidence.
...
**She lied for him in front of a magistrate.** The [[Shinjukamu Letters]] vanished after [[Bayushi Monban]]'s late visit; she rose and told the court he had been returning them at her request; [[Ide Subane]] said in reply that the timeline is exactly the window a forger would need. [[Kitsuki Kaage]] has already warned that accusing an Emerald Magistrate requires substantial evidence — which cuts for her now and against her the moment the librarian is actually called.
...
The shape of the ruling to aim for has not changed and it is nearly built. The [[Imperial-Sealed Official Treaty]] is real and favours the [[Unicorn Clan|Unicorn]]; the [[Scorpion Clan|Scorpion]] instruments are unsealed, unsigned, or vague; the cache is authentic and Imperial intervention is the documented reason the battle ended. Imperial custody is the finding the evidence actually supports. She should stop trying to protect anything else and drive at that.
